...
const AboutUsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-2 sm:px-4 lg:px-8">
      {/* Hero Section with Animation */}
      <div className="w-full max-w-6xl mx-auto text-center mb-10 px-2">
      ...
      <div className="w-full max-w-6xl mx-auto grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 sm:gap-8 px-2">
        {appInfoCards.map((card, index) => (
          ...
          >
            <Card className="h-full bg-white rounded-xl shadow-md overflow-hidden border-0 group flex flex-col justify-between">
              ...
              <CardHeader className="flex flex-row items-start space-x-2 pb-2">
                <div className="p-2 bg-indigo-50 rounded-lg flex items-center justify-center w-12 h-12">
                  {card.icon}
                </div>
                <div>
                  <CardTitle className="text-base sm:text-lg font-bold text-gray-800 group-hover:text-indigo-600 transition-colors duration-300">
                    {card.title}
                  </CardTitle>
                </div>
              </CardHeader>
              ...
              <div className="px-4 pb-3 mt-2">
                <span className="inline-block text-xs sm:text-sm font-medium text-indigo-600 group-hover:text-indigo-800 transition-colors duration-300">
                  Learn more →
                </span>
              </div>
            </Card>
      ...
      <div className="w-full max-w-4xl mx-auto mt-14 px-2">
        <div className="bg-white rounded-2xl shadow-xl p-4 sm:p-8 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="bg-indigo-50 p-4 rounded-lg border-l-4 border-indigo-500">
              <p className="font-medium text-indigo-700 text-xs sm:text-base">
      ...
      <div className="w-full max-w-6xl mx-auto mt-14 px-2">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 sm:gap-8">
          {[
            ...
            <div key={index} className="text-center group">
              <div className="relative inline-block mb-3 overflow-hidden rounded-full w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 border-4 border-white shadow-lg group-hover:border-indigo-300 transition-all duration-300">
                <img 
                  src={person.image} 
                  alt={person.name}
              ...
              <h3 className="text-base sm:text-lg font-bold text-gray-800 group-hover:text-indigo-600 transition-colors duration-300">
                {person.name}
              </h3>
